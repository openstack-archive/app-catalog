...
class AssetUploader(object):
    ...
    def upload_assets(self):
        ...
        for asset_type, asset_id in self._uploaded.values():
            self._patch(asset_type, asset_id, [{
                "op": "replace",
                "path": "/status",
                "value": "active",
            }])
    ...
    def _get_common_data(self, asset):
        data = {}
        _extract_keys(asset, data, "name", "description", "provided_by",
    ...
    def _process_glance(self, asset, data):
        _extract_keys(asset["service"], data,
    ...
    def _process_murano(self, asset, data):
        ...
        self._create_blob("murano_package", package["id"], "package",

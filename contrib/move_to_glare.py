...
class Asset(object):
    ...
    def prepare_data(self):
        asset_draft = {
            ...
            'provided_by': self.bare_data.pop('provided_by'),
            'supported_by': self.bare_data.pop('supported_by', None),
            'release': self.bare_data.pop('release', None),
            'icon': self.bare_data.pop('icon', None),
            'license': self.bare_data.pop('license', None),
            'attributes': self.bare_data.pop('attributes', None),
            'active': self.bare_data.pop('active', True),
            'depends': self.bare_data.pop('depends', []),
        }

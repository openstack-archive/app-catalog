...
def login():
    ...
    Return html form with a bit of javascript. Browser will be redirected to
    launchpad login page, and redirected back to app-catalog if authenticated
    successfully.
    """
...
@auth.route('/process')
def process():
    """Check params given by browser and save data to memcached.

    Browser should contain valid data generated by launchpad. This data
    is checked by Consumer.complete method.
    """
    c = consumer.Consumer(session, store)

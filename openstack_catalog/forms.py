...
class CreateAssetForm(forms.Form):
    ...
    descriprion = forms.CharField(max_length=255)
    ...
    # Check how works without checked
    ...
    licence_url = forms.URLField(required=False)

    stored_object = forms.FileField()

    # Without remote_object_url and remote_object_hash
    attributes = forms.CharField(max_length=255, required=False)
...
class CreateToscaAssetForm(CreateAssetForm):
    ...
    mins = forms.CharField(label="Ever mins array", help_text="three integers"
                           " with space separator", required=False)
    maxs = forms.CharField(label="Ever maxs array", help_text="three integers"
                           " with space separator", required=False)
